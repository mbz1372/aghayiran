...
export default function Home(){return <main>
 ...
 <section id="worlds" className="section worlds-section"><div className="container">
  ...
  <div className="world-grid">
   ...
   <Link href="/shop" className="world-card"><img src="https://www.bikecenter.ir/admin/Slider/picture/Item/original/1.jpg" alt="نمای فروشگاه دوچرخه ایرانی"/><div className="world-index">03</div><div className="world-copy"><span>GEAR / SAFETY</span><h3>تجهیزات</h3><p>کلاه، چراغ، قفل و قطعات مصرفی.</p></div></Link>
  </div>
 </div></section>
